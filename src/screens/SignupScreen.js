...
import { Text, StatusBar, StyleSheet, View, TextInput, Button } from "react-native";
...
import { setSelectedAddress, setUserID, addUserCard, setUserStripeID } from "../actions";
/**
 *
 *
 * NEEEDS TO BE CONFIGURED
 */
											...
											if (data.success) {
												fetch(
													...
													res.json().then((dataID) => {
														...
														route.params.navigation.navigate("Cart Screen");
													});
												});
											}
										});
